page 50002 "Purchase\Transfer Register"
{
    Editable = false;
    PageType = List;
    SourceTable = 50001;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Supplier GST No"; Rec."Supplier GST No")
                {
                }
                field("Consignee Name"; Rec."Consignee Name")
                {
                }
                field("Supplier document Date"; Rec."Supplier document Date")
                {
                }
                field("GST Rate"; Rec."GST Rate")
                {
                }
                field("TCS Details Required"; Rec."TCS Details Required")
                {
                }
                ...
                field("Excise Amount Charge"; Rec."Excise Amount Charge")
                {
                }
                field("BED Amount Charge"; Rec."BED Amount Charge")
                {
                }
                field("ECess Amount Charge"; Rec."ECess Amount Charge")
                {
                }
                field("SUGARCESS Charge"; Rec."SUGARCESS Charge")
                {
                }
                ...
                field("Payable Account Code"; Rec."Payable Account Code")
                {
                }
                field("Payable Account Description"; Rec."Payable Account Description")
                {
                }
                ...
                field("Vend. Items"; Rec."Vend. Items")
                {
                }
    ...
    actions
    {
        area(creation)
        {
            ...
            {
                Caption = 'Update Purchase Register';
