...
{
    DefaultLayout = RDLC;
    RDLCLayout = './SalesReturnTaxInvoice.rdlc';
    ...
    dataset
    {
        dataitem(DataItem1170000000; Table2000000026)
        {
            ...
            dataitem(DataItem1000000000; Table114)
            {
                ...
                dataitem(DataItem1000000031; Table115)
                {
                    ...
                    column(GST_Base_Amt;"Sales Cr.Memo Line"."GST Base Amount")
                    {
                    }
                    column(CGST;decCGST)
                    {
                    ...
                    column(TotalAmt;"Sales Cr.Memo Line"."Amount To Customer")
                    {
                    }
                    column(GST_per;FORMAT(ROUND(decGSTper,1)))
                    {
                    }
                    column(GST;FORMAT(ROUND("Sales Cr.Memo Line"."GST %",1)))
                    {
                    }
                    ...
                    begin
                        ...
                        recDGLE.SETRANGE("GST Component Code",'CGST');
                          IF recDGLE.FIND('-') THEN BEGIN REPEAT
                        ...
                        recDGLE.SETRANGE("GST Component Code",'IGST');
                          IF recDGLE.FINDSET THEN BEGIN REPEAT
                            decGSTper := 0;
                        ...
                        recVE.SETRANGE("Document Line No.","Sales Cr.Memo Line"."Line No.");
                          IF recVE.FIND('-') THEN BEGIN REPEAT
                            recILE.RESET();
