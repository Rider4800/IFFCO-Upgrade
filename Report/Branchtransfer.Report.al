    ...
    dataset
    {
        dataitem(DataItem1170000000; Table2000000026)
        {
            ...
            dataitem(DataItem1000000000; Table5744)
            {
                ...
                column(CompCIN; recCompInfo."Company Registration  No.")
                {
                }
                ...
                column(CompState; recCompInfo.State)
                {
                }
                ...
                dataitem(DataItem1000000043; Table5745)
                {
                    ...
                    column(GSTBaseAmt; "Transfer Shipment Line"."GST Base Amount")
                    {
                    }
                    column(GST_per; ROUND("Transfer Shipment Line"."GST %", 1))
                    {
                    }
                    column(NetAmt; "Transfer Shipment Line".Amount + "Transfer Shipment Line"."Total GST Amount")
                    {
                    }
                    column(IGST; IGSTamt)
                    {
