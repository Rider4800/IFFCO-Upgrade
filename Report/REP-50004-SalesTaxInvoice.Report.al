report 50004 "Sales Tax Invoice"
{
    DefaultLayout = RDLC;
        ...
        dataitem(Integer; Integer)
        {
            ...
            dataitem("Sales Invoice Header"; "Sales Invoice Header")
            {
                ...
                dataitem("Sales Invoice Line"; "Sales Invoice Line")
                {
                    ...
                    column(GST_Base_Amt; GStBAseAmt) //16767 "Sales Invoice Line"."GST Base Amount"
                    {
                    }
                    ...
                    begin
                        ...
                        IF recDGLE.FIND('-') THEN BEGIN
                            ...
                            decGSTper := recDGLE."GST %";
                            IGSTPer := recDGLE."GST %";//16767
                            IgstBaseAmt := Abs((recDGLE."GST Base Amount"))
                        END;
                        GstPer := (IGSTPer + CGSTPer + SGSTPer);//16767
                        GStBAseAmt := (IgstBaseAmt + CgstBaseAmt);//16767
                        //ACX-RK 0507201
                        recItemUOM.RESET();
                        recItemUOM.SETRANGE("Item No.", "Sales Invoice Line"."No.");
                ...
                begin
                    ...
                    IF recSalesCrMemoLine.FIND('-') THEN BEGIN
                        ...
                        dcRoundoffQty := recSalesCrMemoLine.Quantity; //acxcp_250822 //for reduce roundoffqty
                    END;
                    ...
                    IF recSalesCrMemoLine.FIND('-') THEN BEGIN
                        REPEAT
                            ...
                            //16767 decAmounttoCust += recSalesCrMemoLine."Amount To Customer";
                            decAmounttoCust += AmtToCust.GetAmttoCustomerPostedLine(recSalesCrMemoLine."Document No.", recSalesCrMemoLine."Line No.");
