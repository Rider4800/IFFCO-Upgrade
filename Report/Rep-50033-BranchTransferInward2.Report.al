report 50033 "Branch Transfer Inward2"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\ReportLayout\BranchTransferInward2.rdl';
    ...
    dataset
    {
        dataitem("Transfer Shipment Header"; 5744)
        {
            ...
            column(CompTIN; '')//16767 recCompInfo."T.I.N. No."
            {
            }
            ...
            dataitem("Transfer Shipment Line"; 5745)
            {
                ...
                dataitem("Item Ledger Entry"; 32)
                {
                    ...
                    column(Ile_DocLinNo; "Item Ledger Entry"."Document Line No.")
                    {
                    }
