report 50022 "PO-OfficeCopy"
{
    ...
    dataset
    {
        dataitem(DataItem1000000000; Table38)
        {
            ...
            dataitem(DataItem1000000022; Table39)
            {
                ...
                column(GSTAmt; "Purchase Line"."Total GST Amount")
                {
                }
                column(UOM; "Purchase Line"."Unit of Measure Code")
                {
                }
                column(GstPercentage; "Purchase Line"."GST %")
                {
                }
                ...
                begin
                    ...
                    IF recPurchLine.FIND('-') THEN BEGIN
                        REPEAT
                            totAmount += recPurchLine."Amount To Vendor";
    ...
    var
        ...
        IGSTper: Decimal;
        SGSTper: Decimal;
        recGSTLedgerBuffer: Record "16412";
