report 50051 "GSTR-3B NewTest"
{
        ...
        dataitem(SupplyUnreg; "Detailed GST Ledger Entry")
        {
            ...
            begin
                ...
                if not (DetailedGSTLedgerEntryInfo."Component Calc. Type" IN [DetailedGSTLedgerEntryInfo."Component Calc. Type"::General,
                                                                                ...
                                                                                DetailedGSTLedgerEntryInfo."Component Calc. Type"::"Cess %"]) then
                    Count := 0;
    ...
    var
        ...
        TransferShipmentIGSTamt, TransferShipmentIGSTamtFormat : decimal;
    ...
    var
        DetailedGSTLedgerEntry, recDetGSTLedEntry : Record "Detailed GST Ledger Entry";
    ...
    begin
        ...
        StartingDate := DetailedGSTLedgerEntry.GETRANGEMIN("Posting Date");
        EndingDate := DetailedGSTLedgerEntry.GETRANGEMAX("Posting Date");
