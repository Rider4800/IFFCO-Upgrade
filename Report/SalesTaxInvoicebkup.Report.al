report 50104 "Sales Tax Invoice_bkup"
{
    DefaultLayout = RDLC;
    RDLCLayout = './SalesTaxInvoicebkup.rdlc';
        ...
        dataitem(DataItem1170000000; Table2000000026)
        {
            ...
            dataitem(DataItem1000000000; Table112)
            {
                ...
                begin
                    ...
                    RecCheck.FormatNoText(Numbertxt, decAmounttoCust, "Sales Invoice Header"."Currency Code");
