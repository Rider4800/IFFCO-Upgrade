report 50037 "Branch Transfer Inward-New"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\ReportLayout\BranchTransferInwardNew.rdl';
    ...
    dataset
    {
        dataitem("Transfer Shipment Header"; 5744)
        {
            ...
            column(CIN; recCompInfo."GST Registration No.") //16767 "Company Registration  No."
            {
            }
            column(CompTIN; '')//16767 field not found recCompInfo."T.I.N. No."
            {
            }
            ...
            begin
                ...
                IF recLoc.FINDFIRST THEN BEGIN
                    ...
                    //16767 BuyerTIN := recLoc."T.I.N. No.";
                    //16767  BuyerCST := recLoc."C.S.T No.";
            ...
            begin
                ...
                //16767recState.SETRANGE(Code, recCompanyInfo.State);
