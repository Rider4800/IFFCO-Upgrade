report 50049 "Calculate CD"
{
    ...
    dataset
    {
        ...
        {
            DataItemTableView = WHERE (Scheme Calculated=CONST(No),
                ...
                IF recCustLedger.FINDFIRST THEN BEGIN
                    ...
                    IF NOT (InsCalCD.FINDFIRST) AND (recCustLedger."Document Type" = recCustLedger."Document Type"::Payment) THEN BEGIN
                        ...
                        IF recSalesInvoiceLine.FINDFIRST THEN BEGIN
                            REPEAT
                                InsCalCD."Invoice Amt. Exclud GST" += recSalesInvoiceLine."Amount To Customer" - recSalesInvoiceLine."Total GST Amount";
                                InsCalCD."Taxes & Charges Amount" += recSalesInvoiceLine."Total GST Amount";
        ...
        dataitem(AdvancePayment; Table379)
        {
            DataItemTableView = WHERE (Scheme Calculated=CONST(No),
