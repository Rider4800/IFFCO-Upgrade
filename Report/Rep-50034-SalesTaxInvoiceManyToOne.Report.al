report 50034 "Sales Tax Invoice-Many To One"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\ReportLayout\SalesTaxInvoiceManyToOne.rdl';
    //ApplicationArea = all;
    ...
    dataset
    {
        dataitem(Integer; Integer)
        {
            ...
            dataitem("Sales Invoice Header"; 112)
            {
                ...
                column(Company_CIN; recCompanyInfo."GST Registration No.")//16767 "Company Registration  No."
                {
                }
                ...
                dataitem("Sales Invoice Line"; 113)
                {
                    ...
                    column(MRP; 0) //16767 field not found
                    {
                    }
                    ...
                    column(GST_Base_Amt; GstBaseAmt.GetGSTBaseAmtPostedLine("Sales Invoice Line"."Document No.", "Sales Invoice Line"."Line No."))//16767 "Sales Invoice Line"."GST Base Amount"
                    {
                    }
                    ...
                    column(GST; FORMAT(ROUND(GSTper("Document No.", "Line No."), 1)))//16767 "Sales Invoice Line"."GST %"
                    {
                    }
                ...
                begin
                    ...
                    recsaleinvheader.SETRANGE("No.", "Sales Invoice Header"."No.");
                    IF recsaleinvheader.FINDFIRST THEN BEGIN
                        Int := Int + 1;
                    END;
    ...
    var
        ...
        // GstPer: Codeunit 50200;
        AmttoCust: Codeunit 50200;
        Int: Integer;
        Docno: Code[250];
        recsaleinvheader: Record 112;
