report 50126 "GSTR-1 File Format-IMC-bkup"
{
    ...
    dataset
    {
        dataitem(DataItem1500105; Table2000000026)
        {
            ...
            begin
                ...
                MakeExcelBodyB2BA;
                ExcelBuffer.OnlyCreateBook(B2BATxt, B2BATxt, COMPANYNAME, USERID, FALSE);
                ExcelBuffer.DELETEALL;


                MakeExcelBodyB2B;
                ExcelBuffer.OnlyCreateBook(B2BTxt, B2BTxt, COMPANYNAME, USERID, TRUE);
                ExcelBuffer.DELETEALL;
        ...
        IF DetailedGSTLedgerEntry.FINDSET THEN
            REPEAT
                ...
                THEN BEGIN
                    ...
                    IF (DetailedGSTLedgerEntry."Document Type" <> DetailedGSTLedgerEntry."Document Type"::"Credit Memo") AND
                    ...
                    END;
                END;
                IF DetailedGSTLedgerEntry."Document Type" <> DetailedGSTLedgerEntry."Document Type"::"Credit Memo" THEN BEGIN
                    GSTComponent.SETRANGE(Code, DetailedGSTLedgerEntry."GST Component Code");
                    IF GSTComponent.FINDFIRST THEN
                        IF GSTComponent."Report View" <> GSTComponent."Report View"::CESS THEN BEGIN
