    ...
    dataset
    {
        dataitem(DataItem1170000000; Table2000000026)
        {
            ...
            dataitem(DataItem1000000000; Table36)
            {
                ...
                dataitem(DataItem1000000031; Table37)
                {
                    ...
                    column(GST_Base_Amt; "Sales Line"."GST Base Amount")
                    {
                    }
                    ...
                    column(TotalAmt; "Sales Line"."Amount To Customer")
                    {
                    }
                    column(GST_per; FORMAT(ROUND(decGSTper, 1)))
                    {
                    }
                    column(GST; FORMAT(ROUND("Sales Line"."GST %", 1)))
                    {
                    }
                ...
                begin
                    ...
                    IF SalesLine.FIND('-') THEN BEGIN
                        decRoundOff := SalesLine."Amount Including Tax";
                    ...
                    IF SalesLine.FIND('-') THEN BEGIN
                        REPEAT
                            ...
                            decTotalAmount += SalesLine."Amount To Customer" + decRoundOff;
                            decAmounttoCust += SalesLine."Amount To Customer";
