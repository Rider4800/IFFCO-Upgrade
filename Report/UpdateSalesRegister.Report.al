report 50001 "Update Sales Register"
{
    ...
    dataset
    {
        dataitem(DataItem1000000000; Table113)
        {
            DataItemTableView = SORTING (Document No., Line No.)
                                ORDER(Ascending)
                                WHERE (Exported to Sales Register=FILTER(No),
        ...
        dataitem(DataItem1000000002;Table5744)
        {
    ...
    var
        ...
        recPostedStructure: Record "13760";
    ...
    begin
        WITH lSalesInvLine DO BEGIN
           ...
           IF (Type = Type::"G/L Account") AND ("No." = CPG."Invoice Rounding Account") AND ("Line No."<>10000)THEN BEGIN
              ...
              SalesRegister1.FIND('+') ;
              SalesRegister1."Round Off Amount" := "Amount To Customer" ;
              SalesRegister1."Net Amount" += "Amount To Customer" ;
        ...
        //acxav - end
              ...
              IF (Type = Type::Item) AND ("No." <> '') THEN BEGIN
                 ...
                 SalesRegister."Product Group Code" := Item."Product Group Code" ;
              ...
              SalesRegister."Actual Tax %" := lSalesInvLine."Tax %";
        
              SalesRegister."TCS Nature of Collection":=lSalesInvLine."TCS Nature of Collection"; //ACXCP_04102021
              SalesRegister."TCS Amount":=lSalesInvLine."TDS/TCS Amount";//ACXCP_04102021
              ...
              SalesRegister."Abatement %":= "Abatement %";
        ...
        //acxcp
            ...
            //acxcp
             ...
             END;
              ...
              SalesRegister."Tax Amount" := "Tax Amount" ;
              ...
              SalesRegister."Form Code" := lSalesInvHdr."Form Code" ;
              SalesRegister."Form No." := lSalesInvHdr."Form No.";
              ...
              SalesRegister."T.I.N. No." := Cust."T.I.N. No.";
              SalesRegister."No. Series" := lSalesInvHdr."No. Series" ;
        
              SalesRegister."Net Amount" := "Amount To Customer" ;
    ...
    begin
        ...
        //      SalesRegister."CPG Desc" := CPG.Description ;
            ...
            //  SalesRegister."Units per Parcel" := Item."Units per Parcel";
              ...
              SalesRegister."Line Discount Amount" := -"Line Discount Amount" ;
              SalesRegister."Line Amount" := -"Line Amount" ;
              SalesRegister."Actual Tax %" := "Tax %";

              SalesRegister."TCS Nature of Collection":= "TCS Nature of Collection"; //ACXCP_04102021
              SalesRegister."TCS Amount":= -"TDS/TCS Amount";//ACXCP_04102021
        ...
        //acxcp
            ...
            //acxcp
             ...
             END;
              ...
              IF SalesRegister."Tax Type" = SalesRegister."Tax Type"::" " THEN
                 SalesRegister."Tax Type" := SalesRegister."Tax Type"::VAT;
              SalesRegister."Form Code" := lSalesCrMemoHdr."Form Code" ;
              SalesRegister."Form No." := lSalesCrMemoHdr."Form No.";
              SalesRegister."Line Discount %" := "Line Discount %";
    ...
    begin
        ...
        //acxcp
            ...
            //acxcp
              ...
              SalesRegister."Net Amount" := Amount + "Excise Amount" +decTD+decCD+decSD+decOffSeason+decFreight  ;
