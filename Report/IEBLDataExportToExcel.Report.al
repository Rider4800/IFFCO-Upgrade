report 50018 "IEBL Data Export To Excel"
{
    ProcessingOnly = true;
    ...
    dataset
    {
        dataitem(DataItem1000000000; Table113)
        {
            ...
            begin
                ...
                txtData[16] := '';
                recstate.RESET;
                recstate.SETRANGE(Code, "Sales Invoice Line".State);
                ...
                ExcelBuf.AddColumn("Sales Invoice Line"."Posting Date", FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Date);//2
                ExcelBuf.AddColumn("Sales Invoice Line"."Document No.", FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);//3
                ...
                ExcelBuf.AddColumn("Sales Invoice Line".Description, FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);//6
                ExcelBuf.AddColumn("Sales Invoice Line"."Units per Parcel", FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Number);//7
                ExcelBuf.AddColumn("Sales Invoice Line"."No. of Loose Pack", FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Number);//8
                Data1 := 0;
                ...
                ExcelBuf.AddColumn("Sales Invoice Line"."Line Amount", FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Number);//10
                ...
                ExcelBuf.AddColumn("Sales Invoice Line"."Amount To Customer", FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Number);//15
                ...
                ExcelBuf.AddColumn("Sales Invoice Line"."Sell-to Customer No.", FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);//19
                ExcelBuf.AddColumn(txtData[6], FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);//20
                LN := 0;
                IF "Sales Invoice Line"."Line No." <> 0 THEN
                    LN := "Sales Invoice Line"."Line No." / 100
                ELSE
                    LN := 0;
                ...
                ExcelBuf.AddColumn("Sales Invoice Line"."MRP Price", FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Number);//27
                Data3 := 0;
                ...
                LN2 := 0;
                IF "Sales Invoice Line"."Line No." <> 0 THEN
                    LN2 := "Sales Invoice Line"."Line No." / 100
                ELSE
                    LN2 := 0;
                ...
                ExcelBuf.AddColumn("Sales Invoice Line".Quantity, FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Number);//31
