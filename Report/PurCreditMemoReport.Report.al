report 50058 PurCreditMemoReport
{
    ...
    dataset
    {
        dataitem(DataItem1000000001; Table124)
        {
            ...
            column(AmounttoVendorHdr; "Purch. Cr. Memo Hdr."."Amount to Vendor")
            {
            }
            ...
            dataitem(DataItem1000000007; Table125)
            {
                DataItemLink = Document No.=FIELD(No.);
                DataItemTableView = SORTING (Document No., Line No.)
                                    WHERE (System-Created Entry=FILTER(No));
                ...
                column(GSTBaseAmount;"Purch. Cr. Memo Line"."GST Base Amount")
                {
                }
                column(AmountToVendor;"Purch. Cr. Memo Line"."Amount To Vendor")
                {
                }
                column(GSTPercentage;"Purch. Cr. Memo Line"."GST %")
                {
                }
                column(LotNo;LotNo)
                {
                ...
                dataitem(DataItem1000000052;Table32)
                {
                    ...
                    column(LineGst;(ABS(dcLineAmt)* "Purch. Cr. Memo Line"."GST %")/100)
                    {
                    }
                    column(LineAmtwithGST;ABS(dcLineAmt)+((ABS(dcLineAmt)* "Purch. Cr. Memo Line"."GST %")/100 ))
                    {
                    }
            ...
            begin
                ...
                RecCheck.FormatNoText(Numbertxt,("Purch. Cr. Memo Hdr."."Amount to Vendor"+decRoundOff),"Purch. Cr. Memo Hdr."."Currency Code");
