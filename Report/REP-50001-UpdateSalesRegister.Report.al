report 50001 "Update Sales Register"
{
    ...
    begin
        //16767 WITH lSalesInvLine DO BEGIN
        lSalesInvHdr.GET(lSalesInvLine."Document No.");
        Loc.GET(lSalesInvLine."Location Code");
        ...
        IF (lSalesInvLine.Type = Type::"G/L Account") AND (lSalesInvLine."No." = CPG."Invoice Rounding Account") AND (lSalesInvLine."Line No." <> 10000) THEN BEGIN
            SalesRegister1.RESET;
            SalesRegister1.SETRANGE("Document Type", SalesRegister1."Document Type"::"Sales Invoice");
            SalesRegister1.SETRANGE("Source Document No.", lSalesInvLine."Document No.");
            SalesRegister1.FIND('+');
            SalesRegister1."Round Off Amount" := AmtToCust.GetAmttoCustomerPostedLine(lSalesInvLine."Document No.", lSalesInvLine."Line No."); //16767 "Amount To Customer"
            SalesRegister1."Net Amount" += AmtToCust.GetAmttoCustomerPostedLine(lSalesInvLine."Document No.", lSalesInvLine."Line No.");//16767 Amount to Customer 
        ...
        END ELSE BEGIN
            ...
            SalesRegister."Source Document No." := lSalesInvLine."Document No.";
            SalesRegister."Source Line No." := lSalesInvLine."Line No.";
            SalesRegister."Posting Date" := lSalesInvHdr."Posting Date";
            SalesRegister."Source Line Description" := lSalesInvLine.Description;
            SalesRegister."Source Line Description 2" := lSalesInvLine."Description 2"; //ACXCP_03012022
            ...
            SalesRegister.VALIDATE("Responsibility Center", lSalesInvLine."Responsibility Center");//KM
                                                                                                   //acxcp_041021 + //shipto code,name
            SalesRegister."Ship To Code" := lSalesInvHdr."Ship-to Code";
            IF lSalesInvHdr."Ship-to Code" <> '' THEN
                recShipToAddress.SETRANGE("Customer No.", lSalesInvLine."Sell-to Customer No.");
            ...
            SalesRegister."Gen. Bus. Posting Group" := lSalesInvLine."Gen. Bus. Posting Group";
            GBPG.GET(lSalesInvLine."Gen. Bus. Posting Group");
            SalesRegister."GBPG Description" := GBPG.Description;
            GPPG.GET(lSalesInvLine."Gen. Prod. Posting Group");
            ...
            SalesRegister."Outward Location Code" := lSalesInvLine."Location Code";
            ...
            IF (lSalesInvLine.Type = Type::Item) AND (lSalesInvLine."No." <> '') THEN BEGIN
                Item.GET(lSalesInvLine."No.");
            ...
            //16767 New Code add
            IF lSalesInvLine.Type = lSalesInvLine.Type::" " then
                SalesRegister.Type := SalesRegister.Type::" "
            else
                IF lSalesInvLine.Type = lSalesInvLine.Type::"Charge (Item)" then
                    SalesRegister.Type := SalesRegister.Type::"Charge (Item)"
                else
                    IF lSalesInvLine.Type = lSalesInvLine.Type::"Fixed Asset" then
                        SalesRegister.Type := SalesRegister.Type::"Fixed Asset"
                    else
                        IF lSalesInvLine.Type = lSalesInvLine.Type::"G/L Account" then
                            SalesRegister.Type := SalesRegister.Type::"G/L Account"
                        else
                            IF lSalesInvLine.Type = lSalesInvLine.Type::Item then
                                SalesRegister.Type := SalesRegister.Type::Item
                            else
                                IF lSalesInvLine.Type = lSalesInvLine.Type::Resource then
                                    SalesRegister.Type := SalesRegister.Type::Resource;

            //16767 End

            //16767 SalesRegister.Type := Type;
            SalesRegister."No." := lSalesInvLine."No.";
            SalesRegister."Variant Code" := lSalesInvLine."Variant Code";
            SalesRegister."Item Description" := lSalesInvLine.Description;
            ...
            SalesRegister."Unit of Measure" := lSalesInvLine."Unit of Measure Code";
            ...
            SalesRegister.Quantity := lSalesInvLine.Quantity;
            SalesRegister."Unit Price" := lSalesInvLine."Unit Price";
            SalesRegister.Amount := lSalesInvLine.Quantity * lSalesInvLine."Unit Price";
            SalesRegister."Line Discount Amount" := lSalesInvLine."Line Discount Amount";
            SalesRegister."Line Amount" := lSalesInvLine."Line Amount";
            ...
            TdsEntry.SetRange("Document No.", lSalesInvLine."Document No.");
            ...
            //acxcp
            recVle.RESET;
            recVle.SETRANGE("Document No.", lSalesInvLine."Document No.");
            recVle.SETRANGE("Item No.", lSalesInvLine."No.");
            recVle.SETRANGE("Document Line No.", lSalesInvLine."Line No.");
            ...
            SalesRegister."Tax Group Code" := lSalesInvLine."Tax Group Code";
            SalesRegister."Tax Area" := lSalesInvLine."Tax Area Code";

            IF lSalesInvLine."Tax Area Code" <> '' THEN BEGIN
                /*
                FAR 060519
                  TaxAreaLine.RESET ;
            ...
            SalesRegister."Line Discount %" := lSalesInvLine."Line Discount %";
            //16767 Start New Code
            if lSalesInvHdr."Applies-to Doc. Type" = lSalesInvHdr."Applies-to Doc. Type"::" " then
                SalesRegister."Applies-to Doc. Type" := SalesRegister."Applies-to Doc. Type"::" "
            else
                if lSalesInvHdr."Applies-to Doc. Type" = lSalesInvHdr."Applies-to Doc. Type"::"Credit Memo" then
                    SalesRegister."Applies-to Doc. Type" := SalesRegister."Applies-to Doc. Type"::"Credit Memo"
                else
                    if lSalesInvHdr."Applies-to Doc. Type" = lSalesInvHdr."Applies-to Doc. Type"::"Finance Charge Memo" then
                        SalesRegister."Applies-to Doc. Type" := SalesRegister."Applies-to Doc. Type"::"Finance Charge Memo"
                    else
                        if lSalesInvHdr."Applies-to Doc. Type" = lSalesInvHdr."Applies-to Doc. Type"::Invoice then
                            SalesRegister."Applies-to Doc. Type" := SalesRegister."Applies-to Doc. Type"::Invoice
                        else
                            if lSalesInvHdr."Applies-to Doc. Type" = lSalesInvHdr."Applies-to Doc. Type"::Payment then
                                SalesRegister."Applies-to Doc. Type" := SalesRegister."Applies-to Doc. Type"::Payment
                            else
                                if lSalesInvHdr."Applies-to Doc. Type" = lSalesInvHdr."Applies-to Doc. Type"::Refund then
                                    SalesRegister."Applies-to Doc. Type" := SalesRegister."Applies-to Doc. Type"::Refund
                                else
                                    if lSalesInvHdr."Applies-to Doc. Type" = lSalesInvHdr."Applies-to Doc. Type"::Reminder then
                                        SalesRegister."Applies-to Doc. Type" := SalesRegister."Applies-to Doc. Type"::Reminder;

            //16767 End Code
            //16767 SalesRegister."Applies-to Doc. Type" := lSalesInvHdr."Applies-to Doc. Type";
            SalesRegister."Applies-to Doc. No." := lSalesInvHdr."Applies-to Doc. No.";

            SalesRegister."Global Dimension 1 Code" := lSalesInvLine."Shortcut Dimension 1 Code";
            SalesRegister."Global Dimension 2 Code" := lSalesInvLine."Shortcut Dimension 2 Code";
            //16767 SalesRegister."T.I.N. No." := Cust."T.I.N. No.";
            SalesRegister."No. Series" := lSalesInvHdr."No. Series";

            SalesRegister."Net Amount" := AmtToCust.GetAmttoCustomerPostedLine(lSalesInvLine."Document No.", lSalesInvLine."Line No.");//16767 "Amount To Customer";
            ...
            IF (lSalesInvLine."Gen. Prod. Posting Group" <> '') AND (lSalesInvLine."Gen. Bus. Posting Group" <> '') THEN BEGIN
                IF GPS.GET(lSalesInvLine."Gen. Bus. Posting Group", lSalesInvLine."Gen. Prod. Posting Group") THEN BEGIN
    ...
    begin
        ...
        //16767  WITH lSalesCrMemoLine DO BEGIN
        lSalesCrMemoHdr.GET(lSalesCrMemoLine."Document No.");
        IF Loc.GET(lSalesCrMemoLine."Location Code") THEN;
        Cust.GET(lSalesCrMemoLine."Sell-to Customer No.");
        CPG.GET(lSalesCrMemoHdr."Customer Posting Group");
        IF recCustPriceGroup.GET(lSalesCrMemoHdr."Customer Price Group") THEN;

        IF (lSalesCrMemoLine.Type = Type::"G/L Account") AND (lSalesCrMemoLine."No." = CPG."Invoice Rounding Account") AND (lSalesCrMemoLine."Line No." <> 10000) THEN BEGIN
            SalesRegister1.RESET;
            SalesRegister1.SETRANGE("Document Type", SalesRegister1."Document Type"::"Sales Cr. Memo");
            SalesRegister1.SETRANGE("Source Document No.", lSalesCrMemoLine."Document No.");
            SalesRegister1.FIND('+');
        ...
        END ELSE BEGIN
            ...
            SalesRegister."Source Document No." := lSalesCrMemoLine."Document No.";
            SalesRegister."Source Line No." := lSalesCrMemoLine."Line No.";
            SalesRegister."Posting Date" := lSalesCrMemoLine."Posting Date";
            SalesRegister."Source Line Description" := lSalesCrMemoLine.Description;
            SalesRegister."Source Line Description 2" := lSalesCrMemoLine."Description 2"; //ACXCP_03012022
            ...
            SalesRegister."Source Type" := SalesRegister."Source Type"::Customer;
            SalesRegister."Source No." := lSalesCrMemoLine."Sell-to Customer No.";
            SalesRegister."Source Name" := Cust.Name;
            SalesRegister."Source City" := Cust.City;
            SalesRegister.VALIDATE("Responsibility Center", lSalesCrMemoLine."Responsibility Center");//KM
            ...
            IF lSalesCrMemoHdr."Ship-to Code" <> '' THEN
                recShipToAddress.SETRANGE("Customer No.", lSalesCrMemoLine."Sell-to Customer No.");
            ...
            SalesRegister."Customer Price Group Name" := recCustPriceGroup.Description;
            SalesRegister."Gen. Bus. Posting Group" := lSalesCrMemoLine."Gen. Bus. Posting Group";
            GBPG.GET(lSalesCrMemoLine."Gen. Bus. Posting Group");
            SalesRegister."GBPG Description" := GBPG.Description;
            GPPG.GET(lSalesCrMemoLine."Gen. Prod. Posting Group");
            SalesRegister."GPPG Description" := GPPG.Description;
            SalesRegister."Country/Region Code" := Cust."Country/Region Code";
            IF Cust."Country/Region Code" <> '' THEN BEGIN
                Country.GET(Cust."Country/Region Code");
            ...
            END;
            SalesRegister."Territory Dimension Name" := DimValue.Name;
            SalesRegister."Outward Location Code" := lSalesCrMemoLine."Location Code";
            SalesRegister."Outward State Code" := Loc."State Code";
            IF recState.GET(Loc."State Code") THEN BEGIN
                SalesRegister."Outward State Name" := recState.Description;
            END;
            ...
            // Date Treatment Ends
            //16767 New Code add
            IF lSalesCrMemoLine.Type = lSalesCrMemoLine.Type::" " then
                SalesRegister.Type := SalesRegister.Type::" "
            else
                IF lSalesCrMemoLine.Type = lSalesCrMemoLine.Type::"Charge (Item)" then
                    SalesRegister.Type := SalesRegister.Type::"Charge (Item)"
                else
                    IF lSalesCrMemoLine.Type = lSalesCrMemoLine.Type::"Fixed Asset" then
                        SalesRegister.Type := SalesRegister.Type::"Fixed Asset"
                    else
                        IF lSalesCrMemoLine.Type = lSalesCrMemoLine.Type::"G/L Account" then
                            SalesRegister.Type := SalesRegister.Type::"G/L Account"
                        else
                            IF lSalesCrMemoLine.Type = lSalesCrMemoLine.Type::Item then
                                SalesRegister.Type := SalesRegister.Type::Item
                            else
                                IF lSalesCrMemoLine.Type = lSalesCrMemoLine.Type::Resource then
                                    SalesRegister.Type := SalesRegister.Type::Resource;

            //16767 End

            //16767 SalesRegister.Type := Type;
            SalesRegister."No." := lSalesCrMemoLine."No.";
            SalesRegister."Variant Code" := lSalesCrMemoLine."Variant Code";
            SalesRegister."Item Description" := lSalesCrMemoLine.Description;
            ...
            SalesRegister."Unit of Measure" := lSalesCrMemoLine."Unit of Measure Code";
            IF SalesRegister."Variant Code" <> '' THEN BEGIN
                ItemVariant.GET(SalesRegister."No.", SalesRegister."Variant Code");
                SalesRegister."Variant Description" := ItemVariant.Description;
            END;

            IF (lSalesCrMemoLine.Type = Type::Item) AND (lSalesCrMemoLine."No." <> '') THEN BEGIN
                Item.GET(lSalesCrMemoLine."No.");
            ...
            END;
            SalesRegister.Quantity := -lSalesCrMemoLine.Quantity;
            SalesRegister."Unit Price" := -lSalesCrMemoLine."Unit Price";
            SalesRegister.Amount := -(lSalesCrMemoLine.Quantity * lSalesCrMemoLine."Unit Price");
            SalesRegister."Line Discount Amount" := -lSalesCrMemoLine."Line Discount Amount";
            SalesRegister."Line Amount" := -lSalesCrMemoLine."Line Amount";
            //16767 SalesRegister."Actual Tax %" := "Tax %";

            SalesRegister."TCS Nature of Collection" := lSalesCrMemoLine."TCS Nature of Collection"; //ACXCP_04102021
            TdsEntry.Reset();//16767 New Code Add
            TdsEntry.SetRange("Document No.", lSalesCrMemoLine."Document No.");
            if TdsEntry.FindSet() then begin
                repeat
            ...
            //acxcp
            recVle.RESET;
            recVle.SETRANGE("Document No.", lSalesCrMemoLine."Document No.");
            recVle.SETRANGE("Item No.", lSalesCrMemoLine."No.");
            recVle.SETRANGE("Document Line No.", lSalesCrMemoLine."Line No.");
            IF recVle.FINDFIRST THEN BEGIN
                recile.RESET;
                recile.SETRANGE("Entry No.", recVle."Item Ledger Entry No.");
                //   recile.SETRANGE("Item No.",recVle."Item No.");
            ...
            SalesRegister."Tax Group Code" := lSalesCrMemoLine."Tax Group Code";
            SalesRegister."Tax Area" := lSalesCrMemoLine."Tax Area Code";

            IF lSalesCrMemoLine."Tax Area Code" <> '' THEN BEGIN
                TaxAreaLine.RESET;
                TaxAreaLine.SETRANGE("Tax Area", lSalesCrMemoLine."Tax Area Code");
                TaxAreaLine.FIND('-');
                SalesRegister."Tax Jurisdiction Code" := TaxAreaLine."Tax Jurisdiction Code";
            ...
            SalesRegister."Line Discount %" := lSalesCrMemoLine."Line Discount %";
            //16767 Start New Code
            if lSalesCrMemoHdr."Applies-to Doc. Type" = lSalesCrMemoHdr."Applies-to Doc. Type"::" " then
                SalesRegister."Applies-to Doc. Type" := SalesRegister."Applies-to Doc. Type"::" "
            else
                if lSalesCrMemoHdr."Applies-to Doc. Type" = lSalesCrMemoHdr."Applies-to Doc. Type"::"Credit Memo" then
                    SalesRegister."Applies-to Doc. Type" := SalesRegister."Applies-to Doc. Type"::"Credit Memo"
                else
                    if lSalesCrMemoHdr."Applies-to Doc. Type" = lSalesCrMemoHdr."Applies-to Doc. Type"::"Finance Charge Memo" then
                        SalesRegister."Applies-to Doc. Type" := SalesRegister."Applies-to Doc. Type"::"Finance Charge Memo"
                    else
                        if lSalesCrMemoHdr."Applies-to Doc. Type" = lSalesCrMemoHdr."Applies-to Doc. Type"::Invoice then
                            SalesRegister."Applies-to Doc. Type" := SalesRegister."Applies-to Doc. Type"::Invoice
                        else
                            if lSalesCrMemoHdr."Applies-to Doc. Type" = lSalesCrMemoHdr."Applies-to Doc. Type"::Payment then
                                SalesRegister."Applies-to Doc. Type" := SalesRegister."Applies-to Doc. Type"::Payment
                            else
                                if lSalesCrMemoHdr."Applies-to Doc. Type" = lSalesCrMemoHdr."Applies-to Doc. Type"::Refund then
                                    SalesRegister."Applies-to Doc. Type" := SalesRegister."Applies-to Doc. Type"::Refund
                                else
                                    if lSalesCrMemoHdr."Applies-to Doc. Type" = lSalesCrMemoHdr."Applies-to Doc. Type"::Reminder then
                                        SalesRegister."Applies-to Doc. Type" := SalesRegister."Applies-to Doc. Type"::Reminder;

            //16767 End Code
            //16767   SalesRegister."Applies-to Doc. Type" := lSalesCrMemoHdr."Applies-to Doc. Type";
            SalesRegister."Applies-to Doc. No." := lSalesCrMemoHdr."Applies-to Doc. No.";

            SalesRegister."Global Dimension 1 Code" := lSalesCrMemoLine."Shortcut Dimension 1 Code";
            SalesRegister."Global Dimension 2 Code" := lSalesCrMemoLine."Shortcut Dimension 2 Code";
            //16767 SalesRegister."T.I.N. No." := Cust."T.I.N. No.";
            ...
            IF (lSalesCrMemoLine."Gen. Prod. Posting Group" <> '') AND (lSalesCrMemoLine."Gen. Bus. Posting Group" <> '') THEN BEGIN
                IF GPS.GET(lSalesCrMemoLine."Gen. Bus. Posting Group", lSalesCrMemoLine."Gen. Prod. Posting Group") THEN BEGIN
                    SalesRegister."Revenue Account Code" := GPS."Sales Account";
                    IF GLAcc.GET(GPS."Sales Account") THEN
                        SalesRegister."Revenue Account Description" := GLAcc.Name;
                END;
            ...
            SalesRegister.INSERT;
        END;
        lSalesCrMemoLine."Exported to Sales Register" := TRUE;
        lSalesCrMemoLine.MODIFY;
    ...
    begin
        ...
        IF lTransShptLine.FindFirst() THEN BEGIN
            REPEAT
                ...
                Loc.GET(lTransShptLine."Transfer-from Code");
                Loc2.GET(lTransShptLine."Transfer-to Code");
                SalesRegister.INIT;
                ...
                SalesRegister."Source Document No." := lTransShptLine."Document No.";
                SalesRegister."Source Line No." := lTransShptLine."Line No.";
                SalesRegister."Posting Date" := lTransShptHdr."Posting Date";
                SalesRegister."Order No." := lTransShptHdr."Transfer Order No.";
                SalesRegister."Source Line Description" := lTransShptLine.Description;
                SalesRegister."Source Line Description 2" := lTransShptLine."Description 2"; //ACXCP_03012022
                ...
                END;
                SalesRegister."Customer Price Group Name" := recCustPriceGroup.Description;
                IF GPPG.GET(lTransShptLine."Gen. Prod. Posting Group") THEN;
                SalesRegister."GPPG Description" := GPPG.Description;
                ...
                SalesRegister."No." := lTransShptLine."Item No.";
                SalesRegister."Variant Code" := lTransShptLine."Variant Code";
                SalesRegister."Item Description" := lTransShptLine.Description;
                ...
                IF Item.FINDFIRST THEN BEGIN
                    ...
                    SalesRegister."Net Weight" := Item."Net Weight";
                    SalesRegister."Units per Parcel" := Item."Units per Parcel";
                    SalesRegister."Unit of Measure" := lTransShptLine."Unit of Measure Code";
                END;
                //acxcp_060722- //gross weight wrong
                ...
                IF (lTransShptLine."Item No." <> '') THEN BEGIN
                    Item.GET(lTransShptLine."Item No.");
                    //16767 SalesRegister."Excise Prod. Posting Group" := Item."Excise Prod. Posting Group";
                    SalesRegister."Inventory Posting Group" := Item."Inventory Posting Group";
                    SalesRegister."Gen. Prod. Posting Group" := Item."Gen. Prod. Posting Group";
                ...
                END;
                SalesRegister.Quantity := lTransShptLine.Quantity;
                SalesRegister."Unit Price" := lTransShptLine."Unit Price";
                SalesRegister.Amount := lTransShptLine.Quantity * lTransShptLine."Unit Price";
                ...
                //acxcp
                recile.RESET;
                recile.SETRANGE("Document No.", lTransShptLine."Document No.");
                recile.SETRANGE("Document Line No.", lTransShptLine."Line No.");
                recile.SETRANGE("Item No.", lTransShptLine."Item No.");
                IF recile.FINDFIRST THEN BEGIN
                    SalesRegister."Lot No." := recile."Lot No.";
                    recLotInfo.RESET;
                    recLotInfo.SETRANGE("Lot No.", recile."Lot No.");
                ...
                SalesRegister."Net Amount" := lTransShptLine.Amount + /* "Excise Amount" */ +decTD + decCD + decSD + decOffSeason + decFreight; //16767 Field Not found
