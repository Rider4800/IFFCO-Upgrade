Report 50069 "Purchase Invoice Standard"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\ReportLayout\PurchInvStd.rdl';
    ...
    dataset
    {
        dataitem("Purch. Inv. Header"; "Purch. Inv. Header")
        {
            ...
            var
                PurchInvLine: Record "Purch. Inv. Line";
                GSTLedgEntryRec: Record "GST Ledger Entry";
            begin
                CompanyInfo.Get();
                ...
                //->17783
                GSTAmtSum := 0;
                GSTLedgEntryRec.Reset();
                GSTLedgEntryRec.SetRange("Document No.", "Purch. Inv. Header"."No.");
                GSTLedgEntryRec.SetRange("Reverse Charge", true);
                if GSTLedgEntryRec.FindFirst() then begin
                    repeat
                        GSTAmtSum := GSTAmtSum + GSTLedgEntryRec."GST Amount";
                    until GSTLedgEntryRec.Next() = 0;
                end;
                //<-17783
            end;
