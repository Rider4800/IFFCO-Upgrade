report 50030 "Sales Tax Invoice-ManyOld"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\ReportLayout\SalesTaxInvoiceManyOld.rdl';
    ApplicationArea = all;
        ...
        dataitem(Integer; Integer)
        {
            ...
            dataitem("Sales Invoice Header"; 112)
            {
                ...
                dataitem("Sales Invoice Line"; 113)
                {
                    ...
                    column(MRP; 0)//16767 field not found "Sales Invoice Line"."MRP Price"
                    {
                    }
                    ...
                    column(GST_Base_Amt; GstBaseAmt.GetGSTBaseAmtPostedLine("Document No.", "Line No.")) //16767 "Sales Invoice Line"."GST Base Amount"
                    {
                    }
                    ...
                    column(GST; FORMAT(ROUND(GSTper("Document No.", "Line No."), 1))) //16767
                    {
                    }
